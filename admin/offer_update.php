...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE offers SET OfferName='$offer_name', StartDate='$start_date', EndDate='$end_date', Discount_Type='$discount_type', Img='$img' WHERE Offer_ID=$id";
...
<html>
<head>
    <title>Lady Store - Update Offer</title>
</head>
<body>
  <div class="content">
     <div class="title">
     ...
     <form method="post" enctype="multipart/form-data" class="form">
      <h2>Name</h2>
        <input type="text" name="offer_name" value="<?php echo htmlspecialchars($offer_name);?>"><br>
         <h2>Start Date</h2>
      ...
      <input type="date" name="end_date" value="<?php echo htmlspecialchars($end_date);?>"><br>
       <h2>Discount Type</h2>
      <input type="text" name="discount_type" value="<?php echo htmlspecialchars($discount_type);?>"><br>
       <h2>Image</h2>
      <input type="file" name="img"><br>
         <?php if ($img): ?>
            <img src="../image/<?php echo htmlspecialchars($img);?>" alt="Offer Image"><br>
        <?php endif; ?>
        <input type="submit" value="Update" class="update_offer" style="color: white;">
     </form>
         </div>
