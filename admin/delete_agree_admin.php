...
$id = isset($_GET['Admin_ID']) ? intval($_GET['Admin_ID']) : 0;
?>
<!DOCTYPE html>
<html lang="en">
...
<section>
      <h3>Are you sure you want to delete?</h3>
        <div class="delete">
            <a href="admin_delete.php?Admin_ID=<?php echo $id; ?>" class="link" style="background-color: rgb(219, 56, 50); padding: 15px;">Yes</a>
            <a href="admin.php" class="link" style="background-color: green; padding: 15px;">No</a>
        </div>
</section>
</body>
