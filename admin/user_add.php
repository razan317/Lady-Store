...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO `user` (`Username`, `Email`, `Password`, `PhoneNumber`, `Img`) VALUES('$user_name','$email','$password','$phone_number','$img')";
...
<body>
  <div class="content">
    ...
    <form method="post" enctype="multipart/form-data" class="form">
      ...
      <input type="submit" value = "Add" class="user_add" style="color: white;">
    </form>
</div>
    <footer>
    <div class="Contact">
