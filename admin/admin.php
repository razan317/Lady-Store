...
<body>
  ...
  <section class="admins">
     <a href="admin_add.php"><button class="add_admin">Add Admin</button></a>
      ...
      <table class="admin_table">
        ...
        <tbody>
          ...
          while($row = mysqli_fetch_assoc($result)) {
           ...
           echo "<td>
                   <a href='admin_update.php?Admin_ID=" . $row['Admin_ID'] . "' class='link' style='background-color: green; padding: 15px;'>Edit</a>
                   <a href='delete_agree_admin.php?Admin_ID=" . $row['Admin_ID'] . "' class='link' style='background-color: rgb(219, 56, 50); padding: 15px;'>Delete</a>
                     </td>";
              echo "</tr>";
          }
          ?>
