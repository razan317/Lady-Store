...
<body>
 ...
 <nav>
  ...
  <section class="products">
     <a href="product_add.php"><button class="add_pro">Add Product</button></a>
      ...
      <table class="pro_table">
        ...
        <tbody>
          ...
          while($row = mysqli_fetch_assoc($result)) {
           ...
           echo "<td>
                   <a href='product_update.php?Product_ID=" . $row['Product_ID'] . "' class='link' style='background-color: green; padding: 15px;'>Edit</a>
                   <a href='delete_agree_pro.php?Product_ID=" . $row['Product_ID'] . "' class='link' style='background-color: rgb(219, 56, 50); padding: 15px;'>Delete</a>
                     </td>";
              echo "</tr>";
          }
          ?>
