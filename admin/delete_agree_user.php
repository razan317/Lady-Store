...
<section>
      <h3>Are you sure you want to delete?</h3>
        <div class="delete">
            <a href="user_delete.php?User_ID=<?php echo $id; ?>" class="link" style="background-color: rgb(219, 56, 50); padding: 15px;">Yes</a>
            <a href="user.php" class="link" style="background-color: green; padding: 15px;">No</a>
        </div>
</section>
</body>
