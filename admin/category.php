...
<body>
  ...
  <section class="categories">
     <a href="category_add.php"><button class="add_cat">Add Category</button></a>
      ...
      <table class="cat_table">
        ...
        <tbody>
          ...
          while($row = mysqli_fetch_assoc($result)) {
           ...
           echo "<td>
                   <a href='category_update.php?Item_ID=" . $row['Item_ID'] . "' class='link' style='background-color: green; padding: 15px;'>Edit</a>
                   <a href='delete_agree_cat.php?Item_ID=" . $row['Item_ID'] . "' class='link' style='background-color: rgb(219, 56, 50); padding: 15px;'>Delete</a>
                     </td>";
              echo "</tr>";
          }
          ?>
