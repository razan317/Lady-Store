...
<section>
      <h3>Are you sure you want to delete?</h3>
        <div class="delete">
            <a href="category_delete.php?Item_ID=<?php echo $id; ?>" class="link" style="background-color: rgb(219, 56, 50); padding: 15px;">Yes</a>
            <a href="category.php" class="link" style="background-color: green; padding: 15px;">No</a>
        </div>
</section>
</body>
