...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO `product` (`ProductName`, `Description`, `Amount`, `Price`, `Img`) VALUES('$product_name','$description','$amount','$price','$img')";
  ...
  <div class="content">
    ...
    <form method="post" enctype="multipart/form-data" class="form">
      ...
      <input type="file" name="img"><br>
        <input type="submit" value = "Add" class="pro_add" style="color: white;">
    </form>
</div>
    <footer>
    <div class="Contact">
