...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE product SET ProductName='$product_name', Description='$description', Img='$img', Amount='$amount', Price='$price' WHERE Product_ID=$id";
   ...
   <div class="title">
    <h1 style="text-align: center">Update Product</h1>
     ...
     <form method="post" enctype="multipart/form-data" class="form">
        ...
        <h2>Amount</h2>
        <input type="text" name="amount" value="<?php echo htmlspecialchars($amount);?>"><br>
        <h2>Price</h2>
        ...
        <?php endif; ?>
        <input type="submit" value="Update" class="pro_update" style="color: white;">
     </form>
 </div>
     <footer>
    <div class="Contact">
